...
Button(main_window, text="Help", command=display_help(), background=BUTTN_COLOR, width=20).grid(row=20,column=7, columnspan=1, sticky=E)
Button(main_window, text="Toggle for Keybinds", command=toggle_accessibility, background=BUTTN_COLOR, width=20).grid(row=20,column=6, columnspan=1, sticky=E)
